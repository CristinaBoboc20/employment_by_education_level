---
title: "RaportEmployment"
author: "Bucur Denisa, Gherghel Mihnea, Boboc Cristina"
date: "2023-02-09"
output:
    html_document:
    df_print: paged
...
> > ### **Employment by education level** este o aplicație realizată în R care utilizează pachetul Shiny. Această aplicație genereaza informatii utile utilizatorilor in legatura cu procentul de angajare in raport cu nivelul de educatie.
> >
> > ### **Education** - Aici se regăsesc informații referitoare la procentul de angajare in raport cu nivelul de educatie
> >
> > ### **Hours** -Aici se regasesc informatii referitoare la numarul de ore lucrate in medie pe tara 
> >
> > ### **Self employment** -Aici se regăsesc informații referitoare la procentul de a fi propriul tau angajat in functie de tara

```{r echo=FALSE}
# Bucur Denisa, Gherghel Mihnea, Boboc Cristina
# Proiect Probabilitati si Statistica
# Shiny Web Application
# Titlu: Employment by education level

##############################################################


# Pentru realizarea proiectului a fost necesara includerea mai multor librarii. Datele pe baza carora s-au procurat informatele au fost furnizate din OECD (2023) (Employment by education level), prin inluderea fisierului "employment_data.csv"
##################################
...
### In partea de User Interface regasim atat un mainPanel, cat si un sidebarPanel. Aici utilizatorul poate selecta optiunile de care este interesat, realizandu-se, practic, partea de introducere a input-ului. Apoi, in functie de aceste optiuni, se afiseaza tabelul corespunzator cu datele sorate, precum si o diagrama de imprastiere care sa ne redea o interpretare vizuala a rezultatului.
...
## In aceasta parte se realizeaza prelucrarea input-ului pentru a fi afisat utilizatorului.
...
```{r echo=TRUE}
# Crearea aplicatiei prin realizarea conectarii la server si a comunicarii dintre acesta si partea de UserInterface
